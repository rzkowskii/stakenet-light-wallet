...
ActionDialog {
    ...
    signal lnInvoiceRequested(string rHash)

    popUpText: "Invoice details"
    width: 500
    height: 420
    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                SelectedText {
                    text: transaction !== null ? "%1 %2 %3".arg(
                                                     (transaction.txAmount > 0 ? "+" : "-")).arg(
                                                     transaction.delta).arg(
                                                     symbol) : ""
                    color: transaction !== null ? (transaction.txAmount
                                                   > 0 ? "#3FBE4D" : "#D34947") : ""
                    font.pixelSize: 24
            ...
            SelectedText {
                text: transaction
                      !== null ? ("= %1 %2".arg(
                                      transaction !== null ? ApplicationViewModel.localCurrencyViewModel.convert(
                                                                 assetID,
                                                                 transaction.delta) : "").arg(
        ...
        RowLayout {
            ...
            Column {
                ...
                SelectedText {
                    text: transaction !== null ? Utils.formatDate(
                                                     transaction.txDate) : ""
                    font.pixelSize: 13
                    font.family: lightFont.name
                    color: SkinColors.mainText
                ...
                Item {
                    ...
                    RowLayout {
                        ...
                        XSNLabel {
                            ...
                            text: "<a href=\"dummy\">Copy invoice</a>"
                            font.underline: true
                            font.pixelSize: 12
                            font.family: mediumFont.name
                    ...
                    PointingCursorMouseArea {
                        id: copyInvoiceArea
                        onClicked: {
                            lnInvoiceRequested(transaction.txId)
                        }
                    }
                }
            }
