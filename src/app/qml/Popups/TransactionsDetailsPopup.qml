...
ActionDialog {
    ...
    ColumnLayout {
        ...
        ColumnLayout {
            ...
            SelectedText {
                text: transaction !== null ? "%1 %2".arg(transaction.fee).arg(symbol) : ""
                font.pixelSize: 12
                font.family: lightFont.name
                color: SkinColors.mainText
            }
            ...
            SelectedText {
                text: transaction !== null ? ("= %1 %2".arg(transaction !== null ? ApplicationViewModel.localCurrencyViewModel.convert(assetID, transaction.fee) : "").arg(ApplicationViewModel.localCurrencyViewModel.currentCurrencyCode)) : ""
                font.pixelSize: 12
                font.family: lightFont.name
                color: SkinColors.mainText
            }
