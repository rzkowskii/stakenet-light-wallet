...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fapi_2fhttpbody_2eproto = {
  &descriptor_table_google_2fapi_2fhttpbody_2eproto_initialized, descriptor_table_protodef_google_2fapi_2fhttpbody_2eproto, "httpbody.proto", 270,
