 ...
 */
static int ec_privkey_export_der(const secp256k1_context* ctx, unsigned char* privkey,
    size_t* privkeylen, const unsigned char* key32, int compressed)
{
    ...
    if (compressed) {
        ...
        static const unsigned char middle[] = {  };
        ...
        *privkeylen = ptr - privkey;
        ...
        static const unsigned char middle[] = { ,
...
CPrivKey CKey::GetPrivKey() const
{
    ...
    ret = ec_privkey_export_der(secp256k1_context_sign, privkey.data(), &privkeylen, begin(),
...
CPubKey CKey::GetPubKey() const
{
    ...
    assert(ret);
    secp256k1_ec_pubkey_serialize(secp256k1_context_sign, (unsigned char*)result.begin(), &clen,
        &pubkey, fCompressed ? SECP256K1_EC_COMPRESSED : SECP256K1_EC_UNCOMPRESSED);
...
bool CKey::Sign(
    const uint256& hash, std::vector<unsigned char>& vchSig, bool grind, uint32_t test_case) const
{
    if (!fValid)
        return false;
...
{
    if (!ec_privkey_import_der(
            secp256k1_context_sign, (unsigned char*)begin(), privkey.data(), privkey.size()))
        return false;
...
bool CKey::Derive(
    CKey& keyChild, ChainCode& ccChild, unsigned int nChild, const ChainCode& cc) const
{
    assert(IsValid());
    assert(IsCompressed());
